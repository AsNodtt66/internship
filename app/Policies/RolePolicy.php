...
class RolePolicy
{
    ...
    public function view(User $user, Role $role): bool { return $user->hasRole(RoleSlug::PIC); }

    // Core roles are seeded system configuration, not user-defined CRUD data.
    public function create(User $user): bool { return false; }
    public function update(User $user, Role $role): bool { return $user->hasRole(RoleSlug::PIC); }
