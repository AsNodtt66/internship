<x-filament-widgets::widget>
    <x-filament::section heading="Progress Pengajuan">
        @php
            $steps = $this->getSteps();
            $colorMap = [
        ...
        @if (empty($steps))
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Anda belum memiliki pengajuan. Silakan buat pengajuan baru terlebih dahulu.
            </p>
        @else
            {{-- Desktop: horizontal --}}
                ...
                @foreach ($steps as $key => $step)
                    ...
                    <div class="flex flex-col items-center flex-1 relative">
                        <div class="flex items-center w-full">
                            ...
                            <div class="w-4 h-4 rounded-full {{ $c['dot'] }} shrink-0"></div>
